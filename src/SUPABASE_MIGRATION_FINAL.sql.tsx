-- ========================================
-- SUPABASE MIGRATION SCRIPT - FINAL
-- ========================================
...
-- 🔧 FIX: bankDeviceAssignments TEXT -> JSONB
-- IMPORTANT: Bu alan TEXT olarak var, JSONB'ye çevrilmeli!
ALTER TABLE customers 
ALTER COLUMN "bankDeviceAssignments" 
TYPE jsonb 
USING 
  CASE 
    WHEN "bankDeviceAssignments" IS NULL THEN NULL
    WHEN "bankDeviceAssignments" = '' THEN NULL
    WHEN "bankDeviceAssignments"::text ~ '^\[.*\]$' THEN "bankDeviceAssignments"::jsonb
    ELSE NULL
  END;
